...
import '../../App.css';
import workout from "../../images/workout.gif.gif";
...
export default ({
 ...
 description="React project that allows users to track workouts and view progress with dynamically created stats and charts",
  imageSrc=workout,
}) => {
      ...
      <Container>
        <TwoColumn>
          ...
          <RightColumn> <Heading>{heading}</Heading>
            ...
            <SocialLink href="https://github.com/brianneewell1/FitnessTracker">
              <GithubIcon />
            </SocialLink>
