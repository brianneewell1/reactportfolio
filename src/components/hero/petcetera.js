...
import '../../App.css';
import Pet from "../../images/petcetera.gif";
...
export default ({
  heading = "PetCetera",
 description="Pet profile backed by SQL that allows users to save an access important pet information, find local services, and connect with other pet owners. This was a collaboration project with 2 other developers.",
  imageSrc=Pet,
}) => {
      ...
      <Container>
        <TwoColumn>
          ...
          <RightColumn> <Heading>{heading}</Heading>
            ...
            <SocialLink href="https://github.com/brianneewell1/Petcetera">
              <GithubIcon />
            </SocialLink>
            <SocialLink href="https://petcetera.herokuapp.com/">
              <WebsiteIcon />
            </SocialLink>
           </SocialLinksContainer>
           </RightColumn>
