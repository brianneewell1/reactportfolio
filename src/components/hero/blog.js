...
export default ({
  heading = "Collaborative Blog",
 description="CMS-style blog site that allows users to create, update, share, and view blog posts with one another. Technologies used: Express.js, MySQL, Javascript, Handlebars",
  imageSrc=blog,
}) => {
      ...
      <Container>
        <TwoColumn>
          <LeftColumn>
            ...
            <SocialLink href="https://github.com/brianneewell1/blog_application">
              <GithubIcon />
            </SocialLink>
            <SocialLink href="https://blog-app2020.herokuapp.com/">
              <WebsiteIcon />
            </SocialLink>
           </SocialLinksContainer>
           </LeftColumn>
